...
public final class ScreenSplash {
    ...
    final String[] texto = {"Cargando maestros", "Profe, 5.0 por esto", "Viva la innovación",
        "Pintando ventanas", "Limpiando formularios", "Redimensionando íconos", "Conectando con la base de datos",
        "Viva el Poli", "Decorando menús", "Detectando OS",
        "Reintentando conectar a la base de datos", "Oh, esperen", "Conexión establecida",
        ""};
    ...
    public void animar() {
        if (splash != null) {
            ...
            for (int i = 1; i < texto.length; i++) {
                ...
                g.drawString(texto[i - 1] + "...", 203, 338);
